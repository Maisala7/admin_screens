 ...
 requestsState(this.language);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
         Padding(padding: EdgeInsets.only( left: screenWidth/10,right: screenWidth/10,top: screenHeight/10),
         child:  Align(
           alignment: language==1?Alignment.topLeft:Alignment.topRight,
          
           child: Text(language==1?' ID Card Requests  ':'طلبات تجديد البطاقه ',
        ...
        //       future: _databaseHelper.getResquest(),
        //       builder: (context, snapshot) {
        //         if(snapshot.hasData){
        //        return box(language, name:snapshot.data );
        //         }
  ...
  Container(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            Positioned (
              right:language==1? screenWidth/120:screenWidth/300,
              top: screenHeight/18,
              child: SizedBox(
              height:screenHeight/2,
              width:language==1? screenWidth/2.2:screenWidth/6,
            
              child:  Text('اروى يوسف عيد ادريس',
    ...
    Positioned(
      left:language==1? screenWidth/2.5:screenWidth/120,
